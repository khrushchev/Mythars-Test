        ...
        <div class="two-col">
          <div class="form-group">
            ...
            <input type="text" id="review-name" value="${state.identity.name}" placeholder="Enter name…" style="font-size:var(--text-xl);font-family:var(--font-display);"
              oninput="window._setIdentity('name',this.value)">
          </div>
          <div class="form-group">
            <label class="form-label">Age</label>
            <input type="number" id="review-age" value="${state.identity.age}" min="0"
              oninput="window._setIdentity('age',this.value)">
          </div>
          <div class="form-group">
            <label class="form-label">Gender / Pronouns</label>
            <input type="text" id="review-gender" value="${state.identity.gender}"
              oninput="window._setIdentity('gender',this.value)">
          </div>
        </div>
        <div class="form-group">
          <label class="form-label">Background</label>
          <textarea id="review-bg" rows="3" oninput="window._setIdentity('background',this.value)">${state.identity.background}</textarea>
        </div>
      </div>
    </div>
...
window._setIdentity = function(key, val) {
  state.identity[key] = val;
};
